...
*
*  2020-03-26 06:36:33.366746
*/
#ifndef WB_RECEPTORS_NESTML
#define WB_RECEPTORS_NESTML
 ...
 */
extern "C" inline int wb_receptors_nestml_dynamics( double, const double y[], double f[], void* pnode );
...
/* BeginDocumentation
 ...
 peak conductance
  ...
  Initial values:
  alpha_n_init [real]  function alpha_n_init real = 0.032 * (V_m / mV + 52.) / (1. - exp(-(V_m / mV + 52.) / 5.))     
  Inact_h [real]  Act_m real =  alpha_m_init / ( alpha_m_init + beta_m_init )    Activation variable m for Na
...
*/
class wb_receptors_nestml : public nest::Archiving_Node{
public:
  /**
  ...
  */
  wb_receptors_nestml(const wb_receptors_nestml &);
...
private:
  ...
  friend class nest::RecordablesMap<wb_receptors_nestml>;
  friend class nest::UniversalDataLogger<wb_receptors_nestml>;
...
//  Inactivation variable h for Na
  ...
  */
  ...
  /**
    ...
    */
  struct Buffers_ {
    Buffers_(wb_receptors_nestml &);
    Buffers_(const Buffers_ &, wb_receptors_nestml &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<wb_receptors_nestml> logger_;
  ...
  inline double get_alpha_n_init() const {
    return (-0.05) * (S_.ode_state[State_::V_m] / 1.0 + 34.0) / (std::exp((-0.1) * (S_.ode_state[State_::V_m] / 1.0 + 34.0)) - 1.0);
  }

  inline double get_beta_n_init() const {
    return 0.625 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 44.0)) / 80.0);
  }

  inline double get_alpha_m_init() const {
    return 0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)));
  }

  inline double get_beta_m_init() const {
    return 4.0 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 60.0)) / 18.0);
  }

  inline double get_alpha_h_init() const {
    return 0.35 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 58.0)) / 20.0);
  }

  inline double get_beta_h_init() const {
    return 5.0 / (std::exp((-0.1) * (S_.ode_state[State_::V_m] / 1.0 + 28.0)) + 1.0);
  }
  ...
  inline double get_Act_m_inf() const {
    return (0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) / ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) + (4.0 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 60.0)) / 18.0)));
  }

  inline double get_I_Na() const {
    return P_.g_Na * ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) / ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) + (4.0 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 60.0)) / 18.0)))) * ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) / ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) + (4.0 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 60.0)) / 18.0)))) * ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) / ((0.1 * (S_.ode_state[State_::V_m] / 1.0 + 35.0) / (1.0 - std::exp((-0.1*1.0) * (S_.ode_state[State_::V_m] / 1.0 + 35.0*1.0)))) + (4.0 * std::exp((-(S_.ode_state[State_::V_m] / 1.0 + 60.0)) / 18.0)))) * S_.ode_state[State_::Inact_h] * (S_.ode_state[State_::V_m] - P_.E_Na);
  }
...
;
  ...
  */
  ...
  static nest::RecordablesMap<wb_receptors_nestml> recordablesMap_;

  friend int wb_receptors_nestml_dynamics( double, const double y[], double f[], void* pnode );
  
/** @} */
}; /* neuron wb_receptors_nestml */

inline nest::port wb_receptors_nestml::send_test_event(
...
inline nest::port wb_receptors_nestml::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port wb_receptors_nestml::handles_test_event(
...
inline void wb_receptors_nestml::get_status(DictionaryDatum &__d) const{  
...
inline void wb_receptors_nestml::set_status(const DictionaryDatum &__d){
...
#endif /* #ifndef WB_RECEPTORS_NESTML */
#endif /* HAVE GSL */