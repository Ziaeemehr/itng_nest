...
*
*  2020-03-26 06:36:34.571540
*/
#ifndef TRAUB_RECEPTORS_NESTML
#define TRAUB_RECEPTORS_NESTML
 ...
 */
extern "C" inline int traub_receptors_nestml_dynamics( double, const double y[], double f[], void* pnode );
...
*/
class traub_receptors_nestml : public nest::Archiving_Node{
public:
  /**
  * The constructor is only used to create the model prototype in the model manager.
  */
  traub_receptors_nestml();
  ...
  */
  traub_receptors_nestml(const traub_receptors_nestml &);
...
private:
  ...
  friend class nest::RecordablesMap<traub_receptors_nestml>;
  friend class nest::UniversalDataLogger<traub_receptors_nestml>;
  ...
  */
  ...
  /**
    ...
    */
  struct Buffers_ {
    Buffers_(traub_receptors_nestml &);
    Buffers_(const Buffers_ &, traub_receptors_nestml &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<traub_receptors_nestml> logger_;
...
;
  ...
  */
  ...
  static nest::RecordablesMap<traub_receptors_nestml> recordablesMap_;

  friend int traub_receptors_nestml_dynamics( double, const double y[], double f[], void* pnode );
  
/** @} */
}; /* neuron traub_receptors_nestml */

inline nest::port traub_receptors_nestml::send_test_event(
...
inline nest::port traub_receptors_nestml::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port traub_receptors_nestml::handles_test_event(
...
inline void traub_receptors_nestml::get_status(DictionaryDatum &__d) const{  
...
inline void traub_receptors_nestml::set_status(const DictionaryDatum &__d){
...
#endif /* #ifndef TRAUB_RECEPTORS_NESTML */
#endif /* HAVE GSL */