...
tmp_nestml_module tmp_nestml_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

tmp_nestml_module::tmp_nestml_module()
{
#ifdef LINKED_MODULE
...
const std::string
tmp_nestml_module::name(void) const
{
  return std::string("tmp_nestml_module"); // Return name of the module
}

const std::string
tmp_nestml_module::commandstring( void ) const
{
  // Instruct the interpreter to load tmp_nestml_module-init.sli
  return std::string( "(tmp_nestml_module-init) run" );
}

//-------------------------------------------------------------------------------------
void
tmp_nestml_module::init( SLIInterpreter* i )
{
  
    nest::kernel().model_manager.register_node_model<olm_receptors_nestml>("olm_receptors_nestml");
  
} // tmp_nestml_module::init()