...
*
*  2020-01-25 17:07:50.288773
*/
#ifndef OLM_RECEPTORS
#define OLM_RECEPTORS
 ...
 */
extern "C" inline int olm_receptors_dynamics( double, const double y[], double f[], void* pnode );
...
*/
class olm_receptors : public nest::Archiving_Node{
public:
  /**
  ...
  */
  olm_receptors(const olm_receptors &);
...
private:
  ...
  friend class nest::RecordablesMap<olm_receptors>;
  friend class nest::UniversalDataLogger<olm_receptors>;
  ...
  */
  ...
  /**
    ...
    */
  struct Buffers_ {
    Buffers_(olm_receptors &);
    Buffers_(const Buffers_ &, olm_receptors &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<olm_receptors> logger_;
...
;
  ...
  */
  ...
  static nest::RecordablesMap<olm_receptors> recordablesMap_;

  friend int olm_receptors_dynamics( double, const double y[], double f[], void* pnode );
  
/** @} */
}; /* neuron olm_receptors */

inline nest::port olm_receptors::send_test_event(
...
inline nest::port olm_receptors::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port olm_receptors::handles_test_event(
...
inline void olm_receptors::get_status(DictionaryDatum &__d) const{  
...
inline void olm_receptors::set_status(const DictionaryDatum &__d){
